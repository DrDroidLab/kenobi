...
from event.base.column import Column, AttributeColumn, BaseColumn, AttributeColumnV2
from event.base.literal import literal_to_obj, display_literal, obj_to_literal
from protos.event.literal_pb2 import Literal, LiteralType
from protos.event.metric_pb2 import LabelMetadata, Label
from protos.event.query_base_pb2 import ColumnIdentifier, AttributeIdentifier, Op, AttributeIdentifierV2
from protos.event.query_base_pb2 import Expression as ExpressionProto
...
class ColumnToken(Token, Filterable, Annotable, Groupable, Orderable):
    ...
    def group_label(self, obj):
        return Label(
            ...
            display_value=self.column.id_label_resolver_cb(obj) if self._is_id else ''
        )
